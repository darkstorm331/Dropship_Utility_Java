...
public class MarketplaceWebServiceProductsSampleConfig {
    ...
    private static final String accessKey = "AKIAIMDEW7A52MUKBJDA";

    /** Developer AWS secret key. */
    private static final String secretKey = "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";

    /** The client application name. */
    private static final String appName = "Dropship_Util";
